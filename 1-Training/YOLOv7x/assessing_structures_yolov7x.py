# -*- coding: utf-8 -*-
"""assessing_structures_YOLOv7x.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1HOY-k3Ixm5MscJ6lKbWLquTFVKPmF4T7

# Building Detection from High-Resolution Satellite Images Using YOLOv7x: Assessing Collapsed and Non-Collapsed Structures
...
!python train.py --device 0 --batch-size 8 --data data/coco.yaml --img 640 640 --epochs 64 --weights yolov7x.pt --hyp data/hyp.scratch.p5.yaml --name yolov7x
...
image = mpimg.imread('/content/yolov7/runs/train/yolov7x/results.png')
...
image1 = mpimg.imread('/content/yolov7/runs/train/yolov7x/test_batch0_labels.jpg')
image2 = mpimg.imread('/content/yolov7/runs/train/yolov7x/test_batch0_pred.jpg')
